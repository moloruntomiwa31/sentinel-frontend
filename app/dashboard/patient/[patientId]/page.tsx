		...
		<RouteGuard>
			...
			<div className="min-h-screen bg-gray-950 text-white flex flex-col">
				...
				<header className="bg-gray-900 border-b border-gray-800 px-6 py-4 flex items-center gap-4">
					...
					{patient?.risk_level && (
						<span
							className={`px-3 py-1.5 ${risk.badge} text-white text-xs font-semibold rounded-full tracking-wide`}
						>
				...
				<main className="flex-1 p-6 grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-6xl w-full mx-auto">
					...
					<div className="flex flex-col gap-4">
						{/* Risk level card */}
						<div
							className={`rounded-xl border p-5 ${risk.bg} ${risk.border} flex items-center gap-4`}
						>
